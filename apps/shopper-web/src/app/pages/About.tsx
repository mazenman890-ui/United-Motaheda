...
export default function About() {
  ...
  const selectedBranchMapId = searchParams.get("branch") ?? locations[0]?.id ?? "gardenia";
  const selectedBranch = locations.find((branch) => branch.id === selectedBranchMapId) ?? locations[0];
